    ...
    <div id="content_wrap" class="pb3">
      ...
      <div id="flex-container" class="flex mt=2 mb=2">
        ...
        <div id="col2" class="flex-row items-center self-center justify-center content-center w-80 order-1">
          <p>As everything expands to the end of its possibilities,</p>
          <p>and the cold brings homeostasis and simplicity to the universe,</p>
          <p>We bow,</p>
          <p>gently,</p>
          <p>at the unstoppable violence of cause and effect.</p>
        </div>
